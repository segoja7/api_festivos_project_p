...
dependency "role" {
  ...
  mock_outputs = {
    codepipeline_role_id = "mock*"
    codebuild_role_id = "mock*"
  }
}
...
inputs = {
  ...
  codepipeline_role_id =  dependency.role.outputs.codepipeline_role_id
  codebuild_role_id =  dependency.role.outputs.codebuild_role_id
}
